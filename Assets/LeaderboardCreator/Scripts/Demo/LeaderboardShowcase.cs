...
namespace Dan.Demo
{
    public class LeaderboardShowcase : MonoBehaviour
    {
        ...
        public void Load()
        {
            ...
            Leaderboards.TornLeaderBoard.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
        ...
        public void Submit()
        {
            Leaderboards.TornLeaderBoard.UploadNewEntry(_playerUsernameInput.text, _playerScore, Callback, ErrorCallback);
        }
        
        public void DeleteEntry()
        {
            Leaderboards.TornLeaderBoard.DeleteEntry(Callback, ErrorCallback);
        }
        ...
        {
            Leaderboards.TornLeaderBoard.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
        }
